    ...
    <nav className="absolute top-0 w-full p-6 z-30">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex md:space-x-8">
          ...
          <Link href="/how-it-works" className="text-black hover:text-gray-600 transition-colors text-sm">
            How It Works
          </Link>
          <Link href="/research" className="text-black hover:text-gray-600 transition-colors text-sm">
            Research
          </Link>
        </div>
