      ...
      <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
        ...
        <section className="max-w-3xl mx-auto text-center mt-20">
          <h2 className="text-4xl font-bold mb-16">
            The Modern Network for Cancer Research
          </h2>
          
          {/* Search Box - Exactly like reference */}
          <div className="w-full max-w-5xl mx-auto mb-12">
            <div className="relative border border-gray-300 rounded-2xl overflow-hidden bg-white h-20">
              ...
              <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-3">
                ...
                <button className="p-2 text-black border border-gray-300 rounded-md hover:bg-gray-50 w-14 h-14 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
